export default {
  ...
  About1 : 'We can repair most of your treasured jewelry right in our store.',
  Repairs10: ['Ring resizing - we can usually complete the same day, often within an hour','Replace prongs to secure a diamond or color stone','Watch repair'],
  Repairs1: ['Expert Evaluation  & repair',
  'Diamond Setting',
  'Soldering Chains, rings, etc',
  'Switch out clasps',
  'Setting or Re-settings of Diamonds & Gemstones', 
  'Pearl Restringing',
  'Complementary Cleaning',
  'So much more… Come see us today!',],
  Battery1: ['Any type of mechanical and quarts watches', 'Professional certified watch maker. 6 months warranty'],
  ...
  Buy2: ['10K - 14K - 18K - 22K - 24K', 'diamonds', 'jewelry', 'platinum', 'silver', 'any kind gold and silver coins'],
